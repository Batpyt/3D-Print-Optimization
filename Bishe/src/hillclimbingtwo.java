...
public class hillclimbingtwo {
	public String[][] hillclimbingtwo(double[] xs,double[] ys,double[] xe,double[] ye,String[][] blocks,int count){
		...
		hillclimbingtwo annl=new hillclimbingtwo();
